    ...
    return (
        <header style={{ background: '#FFF9E2' }}>
          ...
          style={{ cursor: 'pointer' }}
                                    />
                                    {searchVisible && (
        <div className="search-container absolute top-10 right-10 bg-white p-4 shadow-lg rounded">
          <input
            type="text"
            className="search-field p-2 border border-gray-300 rounded"
            placeholder="Search..."
          />
        </div>
      )}
                    ...
                    <div className="menu" style={navStyle}>
                        ...
                        <div className="nav-item" style={navItemStyle}>
                            <a
                                ...
                                onMouseOut={(e) => {
                                    e.currentTarsget.style.color = linkStyle.color;
                                }}
                            >
                                Unisex                          </a>
                        </div>
