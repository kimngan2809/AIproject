...
const ProductComponent = ({ id, productName, price, brand, imageUrl, sale, price_not_sale, className }) => {
  ...
  const saleBadge = sale ? (
    <div className="absolute top-1 left-1 bg-[#3C8744] text-[#FFF9E2] rounded-full px-5 py-5 text-sm font-bold z-10">
      {sale}
    </div>
  ) : null;
        ...
        <div className="relative group">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-end bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
            <div className="flex space-x-2 mb-2">
              <button className="px-4 py-2 text-[#FFF9E2] bg-[#015109] rounded hover:bg-[#01630B]">
                <img
              ...
              <button className="px-4 py-2 text-[#FFF9E2] bg-[#015109] rounded hover:bg-[#01630B] font-semibold">
                Buy it now
              </button>
            </div>
          </div>
