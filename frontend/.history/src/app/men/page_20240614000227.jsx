...
const MenPage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const menProducts = allProducts.filter(product => product.attributes.category.data.attributes.name === 'Men');

      // Sort products by name
      const sortedProducts = menProducts.slice(0).sort((a, b) => {
  ...
  return (
    <div className="bg-[#fff9e6] text-[#015109]">
      ...
      <div className="container mx-auto mt-10">
        <div className="text-center text-2xl font-bold mb-5">Products for Men</div>
