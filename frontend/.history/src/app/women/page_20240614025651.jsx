...
const WomenPage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const womenProducts = allProducts.filter(product => product.attributes.category.data.attributes.name === 'Women');

      // Sort products by name
      const sortedProducts = womenProducts.slice(0).sort((a, b) => {
  ...
  return (
    <div className="bg-[#fff9e6] text-[#015109]">
      ...
      <div className="container mx-auto mt-10">
        <div className="text-center text-2xl font-bold mb-5">Products for Women</div>
