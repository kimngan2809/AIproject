...
const AddCustomer = () => {
  ...
  const [customerId, setCustomerId] = useState(""); // Customer ID field
  const [image, setImage] = useState(null); // Image upload field
  ...
  const onAddCustomerClick = (e) => {
    ...
    // You can add API call code to save the customer here...
  ...
  const handleImageChange = (e) => {
    setImage(e.target.files[0]); // Save uploaded image
  };
