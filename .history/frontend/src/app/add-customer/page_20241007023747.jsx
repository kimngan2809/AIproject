      ...
      <div className="flex flex-col w-full max-w-md bg-[#F5F5F5] rounded-lg overflow-hidden">
        <div className="p-10 bg-[#F5F5F5]">
          <form className="space-y-3" onSubmit={onAddCustomerClick}>
            ...
            <div className="space-y-0">
  <label htmlFor="image" className="block text-sm font-semibold text-[#458A55]">
    Upload Image
  </label>
  <input
    id="image"
    ...
    required
    className="mt-1 block w-full px-3 py-2 bg-[#D9D9D9] border border-[#458A55] rounded-full text-sm text-[#00000080] focus:outline-none"
    placeholder="No file chosen" // Placeholder for when no file is selected
  />
  <p className="mt-1 text-xs text-[#00000080] italic">
    {image ? image.name : "No file chosen"} {/* Show file name or a default message */}
  </p>
</div>
